...
public class ContaCorrenteComClienteEExececoes {
    private int numero;
    ...
    public ContaCorrenteComClienteEExececoes() {}
    
    public ContaCorrenteComClienteEExececoes(int numero, Cliente cliente, double saldo, Date data, List<String> extrato) {
        this.numero = numero;
    ...
    public void depositar(double valor) {
        if (valor <= 0) throw new DepositoInvalidoException("Operação Inválida");
    ...
    public void sacar(double valor) {
        if (valor > saldo) throw new DepositoInvalidoException("Operação Inválida");
    ...
    public void Transferir (double valor, ContaCorrenteComClienteEExececoes contaDestino) {
